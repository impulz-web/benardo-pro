        ...
        <Container className="max-w-4xl">
          ...
          <section className="mb-10">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <ul className="text-sm text-text space-y-1 ml-4 list-disc">
                  <li>AI-powered front-end prototyping using Gemini and codex</li>
                  <li>Prompt engineering for UI/UX design and workflow automation</li>
                  <li>Full-Stack development (HTML, CSS, JavaScript)</li>
                  <li>React.js, Next Js basics + Vercel deployment</li>
                  <li>WordPress/Elementor development & customizations</li>
                  <li>API integration (REST)</li>
                  <li>Supabase (PostgreSQL) database design, authentication, and real-time APIs</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-text space-y-1 ml-4 list-disc">
                  <li>Git & GitHub</li>
                  <li>Digital marketing & CRM Tools (HubSpot, Zoho, Zapier)</li>
                  <li>SEO, analytics & digital content creation</li>
                  <li>Google search console and google analytics</li>
                </ul>
              </div>
              
              <div>
                <h3 className="text-sm font-semibold text-foreground mb-2">Creative & Additional Skills</h3>
                <ul className="text-sm text-text space-y-1 ml-4 list-disc">
                  <li>Video editing (Adobe Premiere, Photoshop, Canva)</li>
                  <li>Music production (FL Studio, Studio One, Logic Pro)</li>
                  <li>Strategic branding & content marketing</li>
          ...
          <section>
            ...
            <div className="text-sm text-text space-y-2">
              <div>
                <span className="font-semibold text-foreground">Garang Deng Duot</span>, CEO – Godwill Productions | ✉ garangdengduot@gmail.com
              </div>
              <div>
                <span className="font-semibold text-foreground">Samwel Alfayo</span>, CEO – Alfavids & BH Productions | 📞 +254724431589
              </div>
            </div>
          </section>
